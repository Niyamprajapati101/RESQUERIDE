...
function CarCard({ image, name, price, fuel, seats, carId, carStatus }) {
  ...
  return (
    <>
      <div className={`glass-card-neon group relative backdrop-blur-3xl border rounded-3xl overflow-hidden hover:-translate-y-2 transition-all duration-500 hover:bg-white/[0.05] w-72 ${
        theme === 'light'
