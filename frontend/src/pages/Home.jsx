...
function Homecar() {
  ...
  return (
    <div
      className={`${theme === 'light' ? 'bg-white text-gray-900' : 'bg-gradient-to-r from-black via-[#020b1f] to-black text-gray-300'}`}
    >
      <div className="w-full flex flex-col md:relative mt-16 md:mt-0">
        ...
        <div
          className={`
          mt-6 md:mt-22 px-6 md:px-8 py-4 md:py-8 flex flex-col md:flex-row items-center gap-5 md:gap-10 text-center md:text-left
        ...
        >
          <div>
            <p
              ...
              className="text-xs md:text-sm font-bold tracking-widest text-[#94d2bd] md:text-black"
            >
              RESQUERIDE
            </p>
            <h3
              style={{ fontFamily: "'Syne', sans-serif", fontWeight: 700 }}
              className={`text-2xl md:text-xl font-bold mt-1 ${theme === 'light' ? 'text-gray-900' : 'text-white md:text-[#22223b]'}`}
            >
              Fast bookings. Faster rides
            </h3>
            <p
              style={{ fontFamily: "'Syne', sans-serif", fontWeight: 700 }}
              className={`text-sm mt-2 ${theme === 'light' ? 'text-gray-700 md:text-gray-800' : 'text-gray-300 md:text-black'}`}
            >
              Rent Your Dream Car. Transparent pricing. Book in seconds.
            </p>
          </div>
          <Link to="/cars" className="w-full md:w-auto mt-2 md:mt-0">
            <button className=" backdrop-blur-2xl hover:bg-[#7bbda8] text-white border-b-2 font-bold px-8 py-3.5 rounded-xl shadow-lg shadow-[#94d2bd]/30 transition w-full md:w-auto text-lg md:text-base">
              Resque Now
            </button>
          </Link>
        </div>
      ...
      <section className="py-12 md:py-16 px-4 md:px-6 text-center">
        <span
          ...
          className="uppercase inline-flex items-center gap-2 text-amber-400 border border-amber-400/40 rounded-full px-5 py-1 text-sm mb-4"
        >
          <Zap size={16} /> Premium Fleet Selection
        </span>
        <h2
          style={{ fontFamily: "'Syne', sans-serif", fontWeight: 600 }}
          className="text-3xl md:text-5xl text-[#94d2bd] uppercase font-bold"
        >
          Our Car Collection
        </h2>
        <p
          style={{ fontFamily: "'Syne', sans-serif", fontWeight: 600 }}
          className="text-gray-400 text-sm md:text-xl mt-3 mb-2"
        >
      ...
      <section style={{ fontFamily: "'Syne', sans-serif", fontWeight: 600 }} className="py-16 px-6  gap-90">
        <div className="max-w-5xl mx-auto text-center">
          <h2
            style={{ fontFamily: "'Cinzel', serif", fontWeight: 600 }}
            className="uppercase text-4xl font-bold text-white mb-2"
          >
            Our Services
          </h2>
      ...
      {/* ── 4. Why Choose Us ── */}
      <section style={{ fontFamily: "'Syne', sans-serif", fontWeight: 600 }} className="py-16 px-6">
        <div className="max-w-5xl mx-auto text-center">
          <h2
            style={{ fontFamily: "'Cinzel', serif", fontWeight: 600 }}
            className="uppercase text-4xl font-bold text-white mb-2"
      ...
      {/* ── 6. Testimonials ── */}
      <section style={{ fontFamily: "'Syne', sans-serif", fontWeight: 600 }} className=" py-16 px-6">
        <div className="sha max-w-5xl mx-auto text-center ">
          <h2
            style={{ fontFamily: "'Cinzel', serif", fontWeight: 600 }}
            className="uppercase text-4xl font-bold text-white mb-2"
          >
      ...
      <section className="py-14 px-6 ">
        <div className="max-w-4xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          {stats.map((s, i) => (
            <div key={i} className="backdrop-blur-2xl hover:scale-90 text-black border-b-3 font-bold px-8 py-3.5 rounded-xl shadow-xl shadow-[#94d2bd]/30">
